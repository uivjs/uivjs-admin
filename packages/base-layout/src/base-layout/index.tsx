import { ExtractPropTypes, defineComponent, h } from 'vue';
...
const Logo = ({ ...other }: { src?: string }) => (
  <img {...other} style={{ height: '32px' }} />
);

export const baseLayout = {
  title: {
    type: String,
    default: 'UI Vue Admin'
  },
  logoSrc: {
    type: String,
    default: logoURL
...
export type LoginFormProps = ExtractPublicPropTypes<typeof baseLayout>;
    ...
    return () => {
      return (
        <Layout class="uiv-base-layout-wrapper">
          <div style={{ width: '208px', flex: '0 0 208px' }}/>
          <Sider class="uiv-base-layout-menu uiv-base-layout-sider-fixed">
            <div class="uiv-base-layout-sider-children">
              <div style={{ overflow: 'hidden auto', flex: '1 1 0%', height: '100%' }}>
                {slots.menus ? slots.menus() : ''} 
              </div>
              <div class="uiv-base-layout-sider-links">
