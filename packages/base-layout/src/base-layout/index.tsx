      ...
      return (
        <Layout class="uiv-base-layout-wrapper">
          <div
            style={
              collapsed.value
                ? { width: '80px', flex: '0 0 80px', transition: 'all 0.2s' }
                : { width: '200px', flex: '0 0 200px', transition: 'all 0.2s' }
            }
          />
          ...
          <Layout>
            ...
            <Header class="uiv-base-layout-fixed-header">
              ...
              <div class="uiv-base-layout-header-right">{slots.header ? slots.header() : ''}</div>
            </Header>
            <Content>{slots.default ? slots.default() : <router-view />}</Content>
